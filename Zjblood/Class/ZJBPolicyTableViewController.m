//
//  ZJBPolicyTableViewController.m
//  Zjblood
//
...
@interface ZJBPolicyTableViewController ()

@end

@implementation ZJBPolicyTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UINib * nib;
    static NSString *identy = @"ZJBInofTableViewCell2";
    if (!nib) {
