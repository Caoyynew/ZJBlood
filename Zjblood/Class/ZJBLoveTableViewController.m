...
@interface ZJBLoveTableViewController ()

@end

@implementation ZJBLoveTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UINib * nib;
    static NSString *identy = @"ZJBloodHomeTableViewCell2";
    if (!nib) {
